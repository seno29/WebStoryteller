...
<body>
    ...
    <div class="container-fluid">
        <p class="title">Start writing your own masterpiece <%=session.getAttribute("user_mail") %> </p>
        <div class="row">
            <div class="col-sm-3">
            ...
            <%
                ...
                Story s = StoryModel.getStoryById(sid);
            %>
            <div class="col-sm-6">
                <form action="" method="post" id="frm" enctype="multipart/form-data">
                    <label>Give it an eye-catching <b>Title: </b></label>
                    <input type="text" name="title" value="<%=s.getTitle()%>" required><br><br>
                    ...
                    <div id="fTextArea" contenteditable="true" ><%=s.getDescription()%></div>
                    <button type="submit" onclick="insertData('<%=sid%>')" style="width:150px">  Save  </button>
                </form>
            </div> 
...
//                alert(desc.value);
                document.getElementById('frm').setAttribute('action',"EditStoryServlet?SID="+Sid);
            }
        }
