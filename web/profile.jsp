            ...
            <div class="row intro">
                ...
                <div class="col-sm-4 into_col">
                    ...
                    %>
                     ...
                     <a href="myDraft.jsp" class="intro_col_a">My Drafts</a>
                </div>
            </div>          
        </div>
    </div>
...
<div class="my_container">
    <p style="margin-top:50px;margin-left:20%;font-family:'Gabriola';font-size:28px;color:#FB7C39;padding:0px;" ><b>Your Published Stories:</b></p>
<!--        <hr style="color:grey;margin:0px;background-color: black;">-->
         <div class="feeds_div">
                ...
                <div class="col-sm-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <button class="action_btn" ><a class="r_link" href="editStory.jsp?SID=<%=sobj.getSid()%>" style="color:white;" > Edit Story </a></button>
                            <button class="action_btn" ><a class="r_link" href="deleteStory.jsp?SID=<%=sobj.getSid()%>" style="color:white;" > Delete Story </a></button>
